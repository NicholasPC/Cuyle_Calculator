...
wxButton* Factory::createEqual(wxWindow* frame) {return new wxButton(frame, 11011, "=", wxPoint(350, 280), wxSize(140, 70));}

wxButton* Factory::createDecMode(wxWindow* frame) {return new wxButton(frame, 11016, "Dec", wxPoint(280, 70), wxSize(70, 70));}
wxButton* Factory::createHexMode(wxWindow* frame) {return new wxButton(frame, 11017, "Hex", wxPoint(280, 140), wxSize(70, 70));}
wxButton* Factory::createBinMode(wxWindow* frame) {return new wxButton(frame, 11018, "Bin", wxPoint(280, 210), wxSize(70, 70));}

wxButton* Factory::createClear(wxWindow* frame) {return new wxButton(frame, 11021, "Clr", wxPoint(280, 280), wxSize(70, 70));}

wxButton* Factory::createA(wxWindow* frame) { return new wxButton(frame, 11040, "A", wxPoint(350, 70), wxSize(70, 70)); }
wxButton* Factory::createB(wxWindow* frame) { return new wxButton(frame, 11041, "B", wxPoint(420, 70), wxSize(70, 70)); }
wxButton* Factory::createC(wxWindow* frame) { return new wxButton(frame, 11042, "C", wxPoint(350, 140), wxSize(70, 70)); }
wxButton* Factory::createD(wxWindow* frame) { return new wxButton(frame, 11043, "D", wxPoint(420, 140), wxSize(70, 70)); }
wxButton* Factory::createE(wxWindow* frame) { return new wxButton(frame, 11044, "E", wxPoint(350, 210), wxSize(70, 70)); }
wxButton* Factory::createF(wxWindow* frame) { return new wxButton(frame, 11045, "F", wxPoint(420, 210), wxSize(70, 70)); }
